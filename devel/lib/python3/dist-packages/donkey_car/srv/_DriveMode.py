...
"""autogenerated by genpy from donkey_car/DriveModeRequest.msg. Do not edit."""
import codecs
import sys
...
class DriveModeRequest(genpy.Message):
  ...
  _type = "donkey_car/DriveModeRequest"
...
"""
  ...
  _slot_types = ['string','float32','float32','float32','float32','donkey_car/Position[]']
...
def _get_struct_4f():
    ...
    return _struct_4f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from donkey_car/DriveModeResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class DriveModeResponse(genpy.Message):
  ...
  _type = "donkey_car/DriveModeResponse"
  _has_header = False  # flag to mark the presence of a Header object
