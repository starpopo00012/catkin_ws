...
(cl:defmethod cl:initialize-instance :after ((m <ServoConfig>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoConfig)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name donkey_car-msg:<ServoConfig> is deprecated: use donkey_car-msg:ServoConfig instead.")))

(cl:ensure-generic-function 'servo-val :lambda-list '(m))
(cl:defmethod servo-val ((m <ServoConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-msg:servo-val is deprecated.  Use donkey_car-msg:servo instead.")
  (servo m))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <ServoConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-msg:center-val is deprecated.  Use donkey_car-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <ServoConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-msg:range-val is deprecated.  Use donkey_car-msg:range instead.")
  (range m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <ServoConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-msg:direction-val is deprecated.  Use donkey_car-msg:direction instead.")
  (direction m))
