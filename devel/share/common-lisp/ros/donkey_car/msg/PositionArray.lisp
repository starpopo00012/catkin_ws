...
(cl:defmethod cl:initialize-instance :after ((m <PositionArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PositionArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name donkey_car-msg:<PositionArray> is deprecated: use donkey_car-msg:PositionArray instead.")))
