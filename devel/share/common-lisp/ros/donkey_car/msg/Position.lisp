...
(cl:defmethod cl:initialize-instance :after ((m <Position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name donkey_car-msg:<Position> is deprecated: use donkey_car-msg:Position instead.")))
...
(cl:defmethod position-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-msg:position-val is deprecated.  Use donkey_car-msg:position instead.")
  (position m))
