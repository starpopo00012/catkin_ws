...
(cl:defmethod cl:initialize-instance :after ((m <ServoConfigArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoConfigArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name donkey_car-msg:<ServoConfigArray> is deprecated: use donkey_car-msg:ServoConfigArray instead.")))
