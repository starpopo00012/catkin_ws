...
(cl:defmethod cl:initialize-instance :after ((m <Servo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name donkey_car-msg:<Servo> is deprecated: use donkey_car-msg:Servo instead.")))
...
(cl:defmethod value-val ((m <Servo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-msg:value-val is deprecated.  Use donkey_car-msg:value instead.")
  (value m))
