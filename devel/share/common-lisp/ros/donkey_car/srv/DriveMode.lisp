...
(cl:defclass <DriveMode-request> (roslisp-msg-protocol:ros-message)
  ((mode
   ...
   (servos
    :reader servos
    :initarg :servos
    :type (cl:vector donkey_car-msg:Position)
   :initform (cl:make-array 0 :element-type 'donkey_car-msg:Position :initial-element (cl:make-instance 'donkey_car-msg:Position))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DriveMode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveMode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name donkey_car-srv:<DriveMode-request> is deprecated: use donkey_car-srv:DriveMode-request instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <DriveMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-srv:mode-val is deprecated.  Use donkey_car-srv:mode instead.")
  (mode m))

(cl:ensure-generic-function 'rpm-val :lambda-list '(m))
(cl:defmethod rpm-val ((m <DriveMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-srv:rpm-val is deprecated.  Use donkey_car-srv:rpm instead.")
  (rpm m))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <DriveMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-srv:radius-val is deprecated.  Use donkey_car-srv:radius instead.")
  (radius m))

(cl:ensure-generic-function 'track-val :lambda-list '(m))
(cl:defmethod track-val ((m <DriveMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-srv:track-val is deprecated.  Use donkey_car-srv:track instead.")
  (track m))

(cl:ensure-generic-function 'scale-val :lambda-list '(m))
(cl:defmethod scale-val ((m <DriveMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-srv:scale-val is deprecated.  Use donkey_car-srv:scale instead.")
  (scale m))

(cl:ensure-generic-function 'servos-val :lambda-list '(m))
(cl:defmethod servos-val ((m <DriveMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-srv:servos-val is deprecated.  Use donkey_car-srv:servos instead.")
  (servos m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DriveMode-request>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'servos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'donkey_car-msg:Position))
...
(cl:defmethod cl:initialize-instance :after ((m <DriveMode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveMode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name donkey_car-srv:<DriveMode-response> is deprecated: use donkey_car-srv:DriveMode-response instead.")))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <DriveMode-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-srv:error-val is deprecated.  Use donkey_car-srv:error instead.")
  (error m))
