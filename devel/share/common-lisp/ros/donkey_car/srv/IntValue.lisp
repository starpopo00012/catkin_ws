...
(cl:defmethod cl:initialize-instance :after ((m <IntValue-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IntValue-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name donkey_car-srv:<IntValue-request> is deprecated: use donkey_car-srv:IntValue-request instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <IntValue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader donkey_car-srv:value-val is deprecated.  Use donkey_car-srv:value instead.")
  (value m))
...
(cl:defmethod cl:initialize-instance :after ((m <IntValue-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IntValue-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name donkey_car-srv:<IntValue-response> is deprecated: use donkey_car-srv:IntValue-response instead.")))
