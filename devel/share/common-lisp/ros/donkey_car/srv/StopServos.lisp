...
(cl:defmethod cl:initialize-instance :after ((m <StopServos-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StopServos-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name donkey_car-srv:<StopServos-request> is deprecated: use donkey_car-srv:StopServos-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <StopServos-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StopServos-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name donkey_car-srv:<StopServos-response> is deprecated: use donkey_car-srv:StopServos-response instead.")))
