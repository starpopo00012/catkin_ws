...
class NavToLocationRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NavToLocationRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NavToLocationRequest
    let len;
    let data = new NavToLocationRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavToLocationRequest(null);
...
class NavToLocationResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NavToLocationResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NavToLocationResponse
    let len;
    let data = new NavToLocationResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NavToLocationResponse(null);
